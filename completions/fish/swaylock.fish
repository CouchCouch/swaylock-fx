...
complete -c swaylock -l show-clock             -s w --description "Show a clock."
complete -c swaylock -l hide-clock             -s W --description "Hide the clock."
complete -c swaylock -l clock-color                 --description "Sets the color of the clock text."
complete -c swaylock -l clock-font-size             --description "Sets a fixed font size for the clock text."
complete -c swaylock -l clock-x-position            --description "Sets the horizontal position of the clock."
complete -c swaylock -l clock-y-position            --description "Sets the vertical position of the clock."
